...
#define TVR_SHM_KEY     0x411b40e7      //< Shared memory key for the tvrickle system
...
extern tvr_shared_keys_t *tvr_shared_keys;
 ...
 */
static inline uint64_t *tvr_get_page(tvu_int page_nr)
{
    switch (page_nr) {
    case 0:  return NULL;
    case 1:  return tvr_shared_keys->pages[0];
    case 2:  return tvr_shared_keys->pages[1];
    default: return NULL;
    }
}
 ...
 */
static inline tvu_int tvr_get_current_page_nr(void)
{
    if (tvr_shared_keys == NULL) {
        return 0;
    } else {
        return tvr_shared_keys->selected_page;
    }
}
